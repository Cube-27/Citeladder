...
| Opportunities | `domain/opportunities` + `analysis/opportunities` | **Implemented (v1)** — 12 enabled rules (2 visibility + 7 Site Health + 3 commerce), inline-only recompute, supersede-not-mutate history; topic/traffic rules deferred ([`roadmap/opportunities.md`](roadmap/opportunities.md)) |
