...
[`education/the-asian-school/`](education/the-asian-school/) is the first real evaluation. The
Screaming Frog export is the external crawler baseline; a reviewed label set will be the Education
semantic truth. Live `theasianschool.net` access remains opt-in and is never required by normal
tests.
