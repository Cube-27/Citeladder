...
| Interaction | Emerald default: forest `#14532D`; hover `#166534`; pressed `#0B3D20`; brand `#16A34A`; soft `#F0FDF4`; line `#86EFAC`. Other accent ramps live in `globals.css`. | Primary actions on every surface, links, tabs, selection, active navigation, focus, first chart series |
