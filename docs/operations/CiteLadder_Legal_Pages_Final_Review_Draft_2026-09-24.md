...
|---|---|---|
| `/terms` | Part D §1 | Nothing withheld, but three published clauses are the draft's own proposals and need confirmation: the **12-month fee liability cap** and **Pune courts** (D6), and the **18+ business-use** statement (D9). They are live because they limit liability. Confirm them with counsel or ask for their removal. Also dropped: the DPA precedence sentence and the open-source-licence sentence. |
...
1. **Decisions D1–D9** in Part A. Published pages use only settled positions. The three clauses in 0.1 that were published as proposed need confirming: the D2 refund position, the D6 liability cap and Pune courts, and the D9 age and business-use statement.
