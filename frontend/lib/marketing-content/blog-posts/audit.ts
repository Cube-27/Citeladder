...
export const POST_AUDIT: BlogPost = {
  ...
  body: [
    ...
    {
      type: 'subheading',
      text: 'Google Search Console: what the generative AI report does and does not tell you',
    },
    {
      type: 'paragraph',
      text: 'Search Console publishes a Generative AI performance report covering the times links to your site were shown inside a generative AI feature on Google Search. Read its shape carefully before you build a workflow on it, because most of the metrics an SEO team reaches for are not in it:',
    },
    {
      type: 'table',
      caption: 'Search Console generative AI performance report — reported surface',
      headers: ['What you want to know', 'What the report gives you'],
      rows: [
        ...
        [
          ...
          'Not separated. Both features are folded into one combined figure.',
        ],
    ...
    },
    {
      type: 'callout',
      tone: 'warning',
      title: 'Do not compute a citation CTR from this report',
      text: 'Because clicks and queries are absent, any "AI Overview click-through rate" is a number someone assembled from a different denominator. Use the report for what it can support — which pages Google is showing inside AI features, in which countries, on which devices, and how that moves over time — and get the answer text itself from a run you can open.',
    },
    {
      type: 'paragraph',
      text: 'Actionable analysis: sort the report by page and compare it with the pages you expected to carry the topic. A page absent from the impressions list is not being surfaced at all, which is a structural or coverage problem. A page present but flat while a competitor gains is a content-depth problem. Neither conclusion needs a click metric that Google does not publish.',
    },
    {
      type: 'subheading',
