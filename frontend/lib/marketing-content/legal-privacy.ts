...
export const PRIVACY_POLICY: LegalDocument = {
  ...
  sections: [
    ...
    {
      id: 'payment-and-public-data',
      title: 'Payment details and public information',
      paragraphs: [
    ...
    {
      id: 'evidence',
      title: 'Website and project evidence',
      paragraphs: [
    ...
    {
      id: 'ai',
      title: 'AI providers and data use',
      paragraphs: [
    ...
    },
    {
      ...
      title: 'Connected Google and other accounts',
      paragraphs: [
