        ...
        {packs.items.map((pack) => {
          ...
          return (
            <StaggerItem key={pack.name} className="h-full">
              <article className="bg-panel shadow-card hover:shadow-card-hover group flex h-full flex-col rounded-sm p-6 transition-[box-shadow,transform] duration-300 hover:-translate-y-0.5">
