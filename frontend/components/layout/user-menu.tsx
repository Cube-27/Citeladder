    ...
    <div className={cn('flex items-center gap-1', className)}>
      <Dropdown open={open} onOpenChange={(next) => setOpen(presenter, next)}>
        <DropdownTrigger
          ...
          className="focus-ring hover:bg-active hover:text-foreground flex min-w-0 flex-1 items-center gap-2 rounded-[var(--radius-control)] px-2 py-1 text-left transition-colors"
        >
