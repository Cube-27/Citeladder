...
The unified Agent now uses one capability identity across access, model routing and usage configuration. This follows the consolidation of content and growth work into the Agent workspace.
