...
def onboarding_portfolio_system_prompt() -> str:
    return (
        ...
        "navigation labels. "
        "Cover each materially distinct offering or buyer need supported by the "
        "evidence. Give each topic at least one unbranded core question, and add "
        "different decision questions where the evidence supports them. Do not "
        "collapse several offerings into one broad topic or stop after one "
        "question when the evidence supports more. "
