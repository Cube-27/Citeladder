...
4. **Research the facts needed to write.** Read relevant current authoritative sources and a focused market-matched SERP/source sample when available. Use official documents for capabilities, pricing and requirements; distinguish independent opinion from tested fact. Compare what existing pages actually cover. Do not manufacture a source, quotation, testimonial, personal experience, date or statistic.
...
8. **Write the entire requested artifact.** Use clear, specific language and the confirmed brand voice. Explain tradeoffs and who is not a fit. Use natural topic/entity language rather than exact-match stuffing. Reference sources beside material third-party facts. Use real CTA destinations and useful internal links based on inspected pages; never invent URLs. Page titles/descriptions should accurately represent the page, not chase a mechanical character quota.
